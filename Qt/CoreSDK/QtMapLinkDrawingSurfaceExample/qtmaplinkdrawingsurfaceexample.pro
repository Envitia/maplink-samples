...
TARGET = maplinkdrawingsurfaceexample
...
# Common Input
FORMS = qtexample.ui
HEADERS = maplinkwidget.h mainwindow.h application.h qtexample.h
SOURCES = main.cpp mainwindow.cpp maplinkwidget.cpp application.cpp qtexample.cpp
