...
{
public:
  // DisplayInfo class contains all the information necessary to draw the track. Instances are populated as part
  ...
  public:
    ...
    std::vector<TSLCoord> m_historyPoints;
  };
  ...
  bool intersects(double lat, double lon, double tmcPerDU, const TSLCoordinateSystem *coordSys) const;
