...
win32 {
  ...
  RC_FILE = maplinkqpaintersample.rc
...
unix {
  ...
  LIBS += -lMapLink -lMapLinkIModes -lMapLinkOpenGLSurface -lX11 -lXt
  DEFINES += X11_BUILD
  TEMPLATE = app
} 
...
HEADERS = maplinkwidget.h mainwindow.h application.h offscreenrender.h
SOURCES = main.cpp mainwindow.cpp maplinkwidget.cpp application.cpp offscreenrender.cpp
