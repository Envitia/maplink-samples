...
win32 {
  ...
  LIBS += $$quote($${MAPLINK_LIB_DIR}/MapLink3D$${MLS}) \
		  $$quote($${MAPLINK_LIB_DIR}/MapLink$${MLS}) \
		  $$quote($${MAPLINK_LIB_DIR}/MapLink3DIMode$${MLS}) \
		  opengl32.lib
...
unix {
  ...
  LIBS += -lMapLink -lMapLink3D -lMapLink3DIModes
  TEMPLATE = app
} 

# Common Input
FORMS = simple3dinteraction.ui
