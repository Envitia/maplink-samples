...
unix {
  ...
  LIBS += -lMapLink -lMapLinkAccelerator
  TEMPLATE = app
} 

# Common Input
FORMS = qtexample.ui
HEADERS = maplinkwidget.h mainwindow.h application.h qtexample.h AcceleratedSampleCustomDataLayer.h 
SOURCES = main.cpp mainwindow.cpp maplinkwidget.cpp application.cpp qtexample.cpp AcceleratedSampleCustomDataLayer.cpp 
